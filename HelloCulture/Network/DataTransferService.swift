...
public protocol DataTransferService {
    ...
    @discardableResult
    func reqeust<T: Decodable, E: ResponseRequestable>(with endpoint: E, completion: @escaping CompletionHandler<T>) -> NetworkCancellable? where E.Response == T
...
extension DefaultDataTransferService: DataTransferService {
    public func reqeust<T: Decodable, E: ResponseRequestable>(with endpoint: E, completion: @escaping CompletionHandler<T>) -> NetworkCancellable? where T == E.Response {
